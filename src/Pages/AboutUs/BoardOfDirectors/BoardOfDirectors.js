        ...
        <div className='bg-slate-100 max-w-7xl mx-auto'>
            ...
            <div className="card w-96 bg-slate-100 hover:bg-base-100 shadow-xl m-auto">
                ...
                <div className="card-body items-center text-center">
                    <label className="card-title cursor-pointer hover:text-green-700" htmlFor="masud">Ali Ibne Masud</label>
            ...
            <section className='pb-8'>
                <div className='grid grid-cols-1 lg:grid-cols-3 pt-8 gap-5 bg-slate-100 px-8'>
                    <div className="card card-compact max-w-max bg-slate-100 hover:bg-base-100 shadow-xl">
                        ...
                        <div className="card-body items-center text-center">
                            <label className="card-title cursor-pointer hover:text-green-700" htmlFor="arif">MD: Arif Hasan</label>
                    ...
                    <div className="card card-compact max-w-max bg-slate-100 hover:bg-base-100 shadow-xl">
                        ...
                        <div className="card-body items-center text-center">
                            <label className="card-title cursor-pointer hover:text-green-700" htmlFor="nahid">MD. NAHID</label>
                            <p className='font-bold'>Directors </p>
                    ...
                    <div className="card card-compact max-w-max bg-slate-100 hover:bg-base-100 shadow-xl">
                        ...
                        <div className="card-body items-center text-center">
                            <label className="card-title cursor-pointer hover:text-green-700" htmlFor="rijon">Rijon Ahmed</label>
                            <p className='font-bold'>Directors</p>
                    ...
                    <div className="card card-compact max-w-max bg-slate-100 hover:bg-base-100 shadow-xl">
                        <label htmlFor="nahidul">
                            <figure><img className="mask mask-circle w-6/12 mt-5" src='https://i.ibb.co/F3S9tTs/nahidul1.jpg' alt="Nahidul Img" /></figure>
                        </label>
                        <div className="card-body items-center text-center">
                            <label className="card-title cursor-pointer hover:text-green-700" htmlFor="nahidul">Md. Nahidul Islam</label>
                            <p className='font-bold'>Directors</p>
                    ...
                    <div className="card card-compact max-w-max bg-slate-100 hover:bg-base-100 shadow-xl">
                        ...
                        <div className="card-body items-center text-center">
                            <label className="card-title cursor-pointer hover:text-green-700" htmlFor="shuvo">Shabbir Ahmed Shuvo</label>
                            <p className='font-bold'>Directors</p>
                    ...
                    <div className="card card-compact max-w-max bg-slate-100 hover:bg-base-100 shadow-xl">
                        <label htmlFor="Tanvir">
                            <figure><img className='mask mask-circle w-6/12 mt-5' src='https://i.ibb.co/qdrLbrT/tanvir2.jpg' alt="tanvir img" /></figure>
                        </label>
                        <div className="card-body items-center text-center">
                            <label className="card-title cursor-pointer hover:text-green-700" htmlFor="Tanvir">Md Tanvir Alam</label>
                            <p className='font-bold'>Directors</p>
            ...
            <input type="checkbox" id="Tanvir" className="modal-toggle" />
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box">
                    <label htmlFor="Tanvir" className="btn btn-sm btn-circle absolute right-2 top-2 hover:bg-red-700">✕</label>
                    <figure className='w-6/12 m-auto'><img src="https://i.ibb.co/qdrLbrT/tanvir2.jpg" alt="Ali Ibne Masud img" /></figure>
                    <h3 className="font-bold text-lg">Md Tanvir Alam</h3>
            ...
            <input type="checkbox" id="shuvo" className="modal-toggle" />
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box">
                    <label htmlFor="shuvo" className="btn btn-sm btn-circle absolute right-2 top-2 hover:bg-red-700">✕</label>
                    <figure className='w-6/12 m-auto'><img src="https://i.ibb.co/f1VQM5v/Shovo.jpg" alt="Shabbir Ahmed Shuvo" /></figure>
                    <h3 className="font-bold text-lg">Shabbir Ahmed Shuvo</h3>
                    <p className="py-4">You've been selected for a chance to get one year of subscription to use Wikipedia for free!</p>
            ...
            <input type="checkbox" id="nahidul" className="modal-toggle" />
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box">
                    <label htmlFor="nahidul" className="btn btn-sm btn-circle absolute right-2 top-2 hover:bg-red-700">✕</label>
                    <figure className='w-6/12 m-auto'><img src="https://i.ibb.co/F3S9tTs/nahidul1.jpg" alt="Md. Nahidul img" /></figure>
                    <h3 className="font-bold text-lg">Md. Nahidul Islam</h3>
                    <p className="py-4">You've been selected for a chance to get one year of subscription to use Wikipedia for free!</p>
            ...
            {/* Rijon Ahmed Info */}
            <input type="checkbox" id="rijon" className="modal-toggle" />
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box">
                    <label htmlFor="rijon" className="btn btn-sm btn-circle absolute right-2 top-2 hover:bg-red-700">✕</label>
                    <figure className='w-6/12 m-auto'><img src="https://i.ibb.co/wSLNm4t/rijon.jpg" alt="Rijon Ahmed img" /></figure>
                    <h3 className="font-bold text-lg">Rijon Ahmed</h3>
                    <p className="py-4">You've been selected for a chance to get one year of subscription to use Wikipedia for free!</p>
            ...
            {/* MD. NAHID Info */}
            <input type="checkbox" id="nahid" className="modal-toggle" />
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box">
                    <label htmlFor="nahid" className="btn btn-sm btn-circle absolute right-2 top-2 hover:bg-red-700">✕</label>
                    <figure className='w-6/12 m-auto'><img src="https://i.ibb.co/p2DVtt5/nahid1.jpg" alt="MD. NAHID img" /></figure>
                    <h3 className="font-bold text-lg">MD. NAHID</h3>
                    <p className="py-4">You've been selected for a chance to get one year of subscription to use Wikipedia for free!</p>
            ...
            {/* MD: Arif Hasan info */}
            <input type="checkbox" id="arif" className="modal-toggle" />
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box">
                    <label htmlFor="arif" className="btn btn-sm btn-circle absolute right-2 top-2 hover:bg-red-700">✕</label>
                    ...
                    <h3 className="font-bold text-lg">MD: Arif Hasan</h3>
                    <p className="py-4">You've been selected for a chance to get one year of subscription to use Wikipedia for free!</p>
            ...
            {/* Ali Ibne Masud info */}
            <input type="checkbox" id="masud" className="modal-toggle" />
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box">
                    <label htmlFor="masud" className="btn btn-sm btn-circle absolute right-2 top-2 hover:bg-red-700">✕</label>
                    <figure className='w-6/12 m-auto'><img src="https://i.ibb.co/vwKk701/Masud.jpg" alt="Ali Ibne Masud img" /></figure>
                    <h3 className="font-bold text-lg">Ali Ibne Masud</h3>
                    <p className="py-4 text-left">Al-Haj Nur Mohammed was elected as the Chairman of the Board of Directors of Jamuna Bank Limited on April 28, 2022. <br />
