        ...
        <div class="grid flex-grow h-full  py-5 card bg-base-300 rounded-box place-items-center">
          ...
          <div className="w-2/3 mx-auto text-left">
            <div className="my-2">
              ...
              <p className=""><FontAwesomeIcon className='pr-2' icon={faArrowRight} /><span className="text-rose-700"> {myAccounts?.name}</span></p>
            </div>
            <div className="my-2">
              <p className="text-gray-700">Account Number</p>
              <p className=""><FontAwesomeIcon className='pr-2' icon={faArrowRight} /><span className="text-rose-700"> {myAccounts?.AccNo}</span></p>
            </div>
            <div className="my-2">
              <p className="text-gray-700">Available Balance</p>
              <p className=""><FontAwesomeIcon className='pr-2' icon={faArrowRight} /><span className="text-rose-700">$ {myAccounts?.balance}</span></p>
            </div>
