    ...
    return (
        <div className="w-full md:w-3/5 flex flex-col gap-3 lg:w-full mx-auto">
            <div className="bg-gradient-to-l from-blue-500 to-sky-700 px-7 py-3 w-full text-center rounded-xl">
                ...
                {
                    mainAcc ? 
                    <h2 className="text-3xl font-semibold text-white"> $ {crAccount?.balance ? crAccount?.balance?.toFixed(2) : 0.00} </h2> :
                    <h2 className="text-3xl font-semibold text-white"> $ {crAccount?.balance ? crAccount?.balance : 0.00} </h2>
                }
            </div>
