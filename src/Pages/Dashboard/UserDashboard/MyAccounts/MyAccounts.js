                    ...
                    myAccount?.map(account => {
                        ...
                        return (
                            <div className=" mx-auto w-full items-center justify-center p-5 rounded-lg bg-white shadow-lg ">
                                ...
                                <div class="flex flex-col md:flex-row w-full items-center p-5 rounded-lg bg-white shadow-lg">
                                    <div className="w-full p-5 md:w-2/5 items-center mx-auto">
                                        <img class=" object-cover rounded-lg" src={account?.ahimage} alt="" />
                                    </div>
                                    <div class="p-6 w-full md:w-3/5 mx-auto flex flex-col justify-start">
                                        ...
                                        <p class="text-gray-700 text-xs md:text-base font-semibold mb-4"><span className=" text-xs md:text-base px-3 py-1 rounded-full bg-rose-700 text-white">{account?.actype}</span></p>
                                        <p class="text-gray-700 text-xs md:text-base font-semibold mb-4">Acc No: {account?.AccNo}</p>
                                        <p class="text-gray-700 text-xs md:text-base font-semibold mb-4">Balance: $ {account?.balance}</p>
                                        <p class="text-gray-600 text-xs">Account Created {account?.OpeningDate}</p>
                                    </div>
                                </div>
                                <div className="">
