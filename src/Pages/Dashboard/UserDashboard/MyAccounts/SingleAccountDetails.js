    ...
    return (
        <div className="">
            ...
            <button onClick={() => navigate(-1)} type="button"
                ...
                class="inline-block px-6 py-2.5 bg-green-700 my-7 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-green-500 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out" > <FontAwesomeIcon className='pr-2' icon={faBackward} /> Back to Accounts</button>
        </div>
    );
};
