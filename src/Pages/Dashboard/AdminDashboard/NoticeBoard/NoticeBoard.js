...
const NoticeBoard = () => {
    return (
        <div className='md:px-4 px-2 my-6 bg-base-100'>
           ...
           <button className='outline-0 border py-2 px-4 rounded-md bg-primary text-white flex items-center text-xl font-sans font-medium shadow-md'>New Notice</button>
           </div>
