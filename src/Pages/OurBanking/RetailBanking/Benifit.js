    ...
    return (
        <div>
            <div className="w-full h-full bg-slate-200">
                <img className='object-cover h-full' src="https://www.nrbcommercialbank.com/assets/img/product/double.jpg" alt="" />
            </div>
            <div className="w-full lg:w-3/5 mx-auto">
                <h3 className="text-3xl text-green-500 py-10 text-center font-bold">DOUBLE BENEFIT DEPOSIT SCHEME</h3>
                <p className="text-justify text-gray-500 font-semibold">Under this scheme deposited amount will be doubled at 11 years. Any type of customer can open this scheme in his own name or jointly by depositing Tk 10,000 or its multiple.</p>
                            ...
                            <div className="accordion-item border border-gray-200">
                                <h2 className="accordion-header mb-0" id="headingOne">
                                    <button className=" accordion-button relative flex items-center w-full py-4 px-5 text-base text-gray-800 text-left  bg-white border-0 rounded-none transition focus:outline-none marker:"
                                        ...
                                        <span className="text-green-700 font-bold"> <span className="font-bold text-md"><FontAwesomeIcon icon={faPlus} /></span> Interest Rate</span>
                                    </button>
                                </h2>
                                <div id='itemsthree' className="accordion-collapse collapse" aria-labelledby="headingOne"
                                    ...
                                    <div className="accordion-body py-4 px-5 flex justify-around items-center">
                                        <div className="w-5/6 mx-auto flex justify-center items-center">
                                            <p className="text-gray-600 space-y-2">Under this scheme deposited amount will be doubled at 11 years 9 Months.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
