    ...
    <div className='flex flex-col md:flex-row justify-center w-full items-center p-5 gap-3 mx-auto'>
      ...
      <div className="flex flex-col w-full md:w-3/6 items-center justify-center gap-3">
        <div class="mb-3 w-full lg:w-96">
          ...
          <input required name="NIDFront" onChange={handleChange} value={CAData["NIDFront"] || ""} type="text" class=" form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none "
        ...
        <div class="mb-3 w-full lg:w-96">
          ...
          <input required name="NIDBack" onChange={handleChange} value={CAData["NIDBack"] || ""} type="text" class=" form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none "
        ...
        <div class="mb-3 w-full lg:w-96">
          ...
          <textarea required name="address" onChange={handleChange} value={CAData["address"] || ""} type="text" class="textarea textarea-accent w-full resize-none" placeholder="Enter Your Address"></textarea>
        </div>
      </div>
