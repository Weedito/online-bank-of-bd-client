...
const OruTrustedPartners = () => {
    return (
        <div className="flex justify-center items-center bg-slate-100 flex-col py-20  px-2">
          <div className="title">
          ...
          <div className="grid grid-cols-1 items-center justify-center md:grid-cols-2 lg:grid-cols-4 mt-12 gap-8">
            {/* partner summary  */}
             {
                TrustedPartnersData.map((item, idx) => {
                    return(
                        <img className='p-10' key={idx} src={item?.imageURL} alt="partners" />
                    )
                })
             }
