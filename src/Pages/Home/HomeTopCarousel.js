...
const HomeTopCarousel = () => {
    ...
    return (
        // <div className="bg-gradient-to-tr from-green-900 to-green-700 h-fit w-full bg-cover bg-center">
        //     <img
        //         src="https://preview.colorlib.com/theme/direngine/images/bg_4.jpg.webp"
        //         alt=""
        //         className="h-[400px] w-full object-cover absolute mix-blend-overlay"
        //     />
                    ...
                    {slides.map((slide, index) => <div key={index}>
                        <div className="flex justify-between items-center p-5 w-full max-w-7xl mx-auto gap-3">
                            ...
                            <div className='w-3/6 flex justify-center mx-auto'>
                                <img className='' src="https://i.ibb.co/8zhtLf0/Vector.png" alt="" />
                            </div>
                        </div>
                    </div>)}
                </Slider>
