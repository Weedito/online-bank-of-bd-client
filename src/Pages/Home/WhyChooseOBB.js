  ...
  return (
    <div className='bg-base-200 pb-5'>
      <div className='pt-8 pb-5'>
        <h1 className='text-2xl font-bold mt-5'>Why Choose <span className='text-green-700 font-serif font-bold'>Online Bank BD</span></h1>
        <h1 className='text-3xl font-bold text-green-700'>__</h1>
      </div>
