      ...
      <div className="myProfile lg:w-11/12 lg:mx-16 md:mx-6 mx-1 lg:flex gap-10 -mt-72 mb-20">
        ...
        <div className="profile-customize w-full lg:mt-28 mt-10">
          <div class="h-fit bg-base-100 shadow-xl rounded-2xl">
            <div class="card-body">
              <div className="profileCustomizeHead lg:flex md:gap-3 justify-between">
                <div className="account">
                  <button className="btn normal-case text-white bg-indigo-700 px-10 btn-ghost shadow-indigo-300 shadow-lg rounded-2xl">
                    Account
                  </button>
                </div>
                ...
                <div className="infoUpdate mt-10">
                  <form>
                    <div className="fullNameField lg:flex gap-8">
                      ...
                      <InputField label="Last Name" name="Dev"></InputField>
                    </div>
